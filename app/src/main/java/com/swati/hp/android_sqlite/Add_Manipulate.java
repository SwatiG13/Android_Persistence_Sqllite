...
public class Add_Manipulate extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(personID > 0) {
            ...
            rs.moveToFirst();
            String personName = rs.getString(rs.getColumnIndex(DB_Helper.PERSON_COLUMN_NAME));
            String personGender = rs.getString(rs.getColumnIndex(DB_Helper.PERSON_COLUMN_GENDER));
            int personAge = rs.getInt(rs.getColumnIndex(DB_Helper.PERSON_COLUMN_AGE));
            if (!rs.isClosed()) {
                rs.close();
            }
